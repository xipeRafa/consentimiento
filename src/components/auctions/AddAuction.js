...
/*   const [lati, setLati]=useState('no-gps')
  ...
  `  )) {
    ...
    if (!imgTypes.includes(itemImage.current.files[0].type)) {
      return console.log("Please use a valid image");
    }
  ...
  return (
    <>
        <h2 className=" px-5">hola soy la informacion del Consentimiento</h2>
        <h2 className=" px-5">hola soy la informacion del Consentimiento</h2>
        <h2 className=" px-5">hola soy la informacion del Consentimiento</h2>
        <h2 className=" px-5">hola soy la informacion del Consentimiento</h2>
        <h2 className=" px-5">hola soy la informacion del Consentimiento</h2>

      <div className="d-flex flex-direction-column justify-content-center my-3 ">
        ...
        <form onSubmit={submitForm} style={{backgroundColor:'rgb(222,222,222)'}}>
          <Modal.Body>
            ...
            <Col className="border mb-4 btn bg-primary mx-2 p-2 text-center text-white">
                  ...
                  ÍNDICE DE ANSIEDAD DENTAL Y FOBIA 
              </Col>
            </Row>
            ...
            <Row>
              <Col className="mb-2">
                <Form.Group>
                  <Form.Label>Pregusta 1</Form.Label>
            ...
            <Row>
              <Col className="mb-2">
                <Form.Group>
                  <Form.Label>Pregusta 2</Form.Label>
                  <Form.Control type="text" required ref={itemTitle} />
                </Form.Group>
              </Col>
            ...
            <Row>
              <Col className="mb-2">
                <Form.Group>
                  <Form.Label>Pregusta 3</Form.Label>
                  <Form.Control type="text" required ref={itemTitle} />
                </Form.Group>
              </Col>
...
{/*             <Row className={dist === 'dos' && 'd-none'} >
            <Col>
              ...
              <Form.Control type="search" list="finder1" onChange={handleTienda1} className="mb-3" 
                            value={tienda1}
              />
          ...
          <Row className={dist === 'uno' && 'd-none'} >
            <Col>
              ...
              <Form.Control type="search" list="finder2" onChange={handleTienda1} className="mb-3" 
                            value={tienda1}    
              />
